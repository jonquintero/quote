            ...
            <dropdown class="mt-1" placement="bottom-end">
              ...
              <template #dropdown>
                <div class="mt-2 py-2 text-sm bg-white rounded shadow-xl">
                  <Link class="block px-6 py-2 hover:text-white hover:bg-indigo-500" :href="route('users.edit', $page.props.auth)">My Profile</Link>
                  <Link class="block px-6 py-2 hover:text-white hover:bg-indigo-500" :href="route('users.index')">Manage Users</Link>
