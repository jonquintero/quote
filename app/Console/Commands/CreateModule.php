...
class CreateModule extends Command
{
    ...
    protected function generateFolders($moduleName, $modulePath)
    {
        $folders = [
            'Actions',
            'Database/Factories',
    ...
    protected function generateFiles($moduleName, $modulePath)
    {
        ...
        foreach ($files as $file) {
            ...
            // Reemplazar la etiqueta {{moduleName}} en el nombre del archivo y eliminar la extensión .stub
    ...
    protected function generateModel($moduleName, $modulePath)
    {
    ...
    protected function generateController($moduleName, $modulePath)
    {
    ...
    protected function generateMigration($moduleName, $modulePath)
    {
    ...
    protected function generateFormRequest($moduleName, $modulePath)
    {
